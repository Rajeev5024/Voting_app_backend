...
import { addCandidate, candidatesList, deleteCandidate, updateCandidateProfile, voteCandidate, voteCount } from "../controller/candidate.controller.js";
...
router.route("/list").get(candidatesList)
